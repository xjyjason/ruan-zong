package com.ruanzong.blogsystem.service;

import com.ruanzong.blogsystem.dao.UserMapper;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        // 给注册用户发送激活邮件
        String content = "您的激活码是："+user.getActivationCode();
    ...
    public Map<String, Object> doSendEmailCode4ResetPwd(String account) {
        ...
        // 给注册用户发送重置密码验证邮件
        String content = "您的重置密码验证码是： "+ randomCode;
